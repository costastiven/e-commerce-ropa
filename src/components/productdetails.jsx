        ...
        <div className="col-lg-6">
          <div className="card p-3 m-auto">
            <div className="card-body">
              ...
              <p className="card-text mb-3">Producto muy comodo que esta a la moda y esta<br /> hecho con los mejores materiales y calidad del mercado.</p>
          ...
          <div className="card">
            ...
            <h2 className="text-center mb-2">Más productos del mismo</h2>
            <p className="mb-2">¡Tenemos más productos, visita la tienda para obtener ofertas increíbles!</p>
            </div>
