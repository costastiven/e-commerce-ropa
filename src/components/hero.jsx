        ...
        <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Órd. Rápidas</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Envío rápido</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Altos ahorros</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Soporte 24/7</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Pedidos online</p>
              </div>
            </div>
          </div>
        </div>
