...
<div className="container card my-3">
      <div className="row g-3">
        ...
        <div className="col-12 col-md-7">
          <div className="p-3">
            <h2>{name}</h2>
            <p className="cart-item-id">Producto de marca: <b className='text-center mb-1'>{brand}</b></p>
            <p className="cart-item-id">Precio del producto: <b className='text-center mb-1'>${price}</b></p>
            <p className="cart-item-id">Número de producto: <b className='text-center mb-3'>{id}</b></p>
            <p className="cart-item-id">Artículos en stock: <b className='text-danger'>{itemsInStock}</b></p>
          </div>
          ...
          <div className="p-3">
            <input type="text" className="form-control" id="coupon" placeholder="Código de cupón..." />
          </div>
        </div>
      </div>
    </div>
